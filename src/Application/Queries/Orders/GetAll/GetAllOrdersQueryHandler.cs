...
internal class GetAllOrdersQueryHandler : IQueryHandler<GetAllOrdersQuery, IEnumerable<GetAllOrdersResponseOrder>>
{
    ...
    public async ValueTask<IEnumerable<GetAllOrdersResponseOrder>> Handle(GetAllOrdersQuery request, CancellationToken cancellationToken)
    {
